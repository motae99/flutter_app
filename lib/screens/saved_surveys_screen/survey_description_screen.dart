...
import 'package:flutter_app/screens/saved_surveys_screen/question_list_screen.dart';
// import 'package:flutter_app/widget/map_widget.dart';
...
class _SurveyDescriptionScreenState extends State<SurveyDescriptionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(AppLocalizations.of(context).tr("Survey Description")),
        ),
        body: Form(
          ...
          child: ListView(
            children: [
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: new InputDecoration(
                    hintText: AppLocalizations.of(context).tr("Town Name"),
                  ...
                  validator: (value) {
                    if (value.isEmpty) {
                      return AppLocalizations.of(context).tr("Enter Town Name");
                    }
                    return null;
                  },
                ),
              ...
              Container(
                ...
                child: Text(AppLocalizations.of(context).tr("Choose Location")),
              ),
              SizedBox(
                height: 10,
              ),
